...
import main.embl.rieslab.emu.ui.uiproperties.filters.NoPropertyFilter;
import main.embl.rieslab.emu.ui.uiproperties.filters.PropertyFilter;

public class SnapAcquisition extends Acquisition {
	
	// Convenience constants		
	private final static String PANE_NAME = "Snap panel";
	...
	public SnapAcquisition(double exposure, HashMap<String,String[]> configgroups) {
		super(AcquisitionType.SNAP, exposure, configgroups);

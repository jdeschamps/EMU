...
public class LocalizationAcquisition extends TimeAcquisition {
	...
	public LocalizationAcquisition(AcquisitionType type, String path, String name, ConfigurationGroup group, String configname, 
			int numframes, int intervalframes, HashMap<String, String> propvalues, TaskHolder activation, boolean useactivation, int waitonmax, TwoStateUIProperty property3D, boolean use3D) {

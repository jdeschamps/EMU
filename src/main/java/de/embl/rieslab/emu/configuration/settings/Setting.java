...
public abstract class Setting<T> {
	...
	/**
	 * Returns the setting value as a String. Used to display the setting in the {@link de.embl.rieslab.emu.configuration.ui.SettingsTable SettingsTable}.
	 * @see de.embl.rieslab.emu.configuration.ui.SettingsTable
	 * 

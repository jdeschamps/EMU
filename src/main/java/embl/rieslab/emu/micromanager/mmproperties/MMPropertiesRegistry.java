package main.java.embl.rieslab.emu.micromanager.mmproperties;
...
public class MMPropertiesRegistry {
	 ...
	 * Called during reloading of the system by the {@link main.java.embl.rieslab.emu.controller.SystemController}.
	 * 
	 */

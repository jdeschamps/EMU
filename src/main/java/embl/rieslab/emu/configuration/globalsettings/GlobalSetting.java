...
public abstract class GlobalSetting<T> {
	...
	/**
	 * Returns the setting value as a String. Used to display the setting in the {@link main.java.embl.rieslab.emu.configuration.ui.GlobalSettingsTable GlobalSettingsTable}.
	 * @see main.java.embl.rieslab.emu.configuration.ui.GlobalSettingsTable
	 * 

...
public class StringMMPropertyTest {
	...
	public void testAreEquals() {
		final StringMMProperty prop = new StringMMProperty(null, "", "", "") {
			@Override
	...
	public void testFloatProperty() {
		...
		final StringMMProperty prop = new StringMMProperty(null, device, property, false) {
			@Override
			public String getValue() { // avoids NullPointerException
				return "";
			}
	...
	public void testFloatPropertyReadOnly() {
		final String device = "My device";
		final String property = "My property";
		final StringMMProperty prop = new StringMMProperty(null, device, property, true) {
			@Override
			public String getValue() { // avoids NullPointerException
				return "";
			}
	...
	public void testAllowedValues() {
		...
		final StringMMProperty prop = new StringMMProperty(null, "", "", vals) {
			@Override
			public String getValue() { // avoids NullPointerException
				return "";
			}
		...
		for(int i=0;i<vals.length;i++)
			assertEquals(vals[i], vals_copy[i].toString());
	...
	public void testLimitedValues() {
		...
		final StringMMProperty prop = new StringMMProperty(null, "", "", max, min) {
			@Override
			public String getValue() { // avoids NullPointerException
				return "";
			}
